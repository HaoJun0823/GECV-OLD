...
int get_pid(const wchar_t* processName) {
...
BOOL c_fn_memory::set_privilege(HANDLE processhandle, std::string perm)
{
    ...
    {
        if (LookupPrivilegeValueA(NULL, permchar, &permissionidentifier))
        {
...
BOOL c_fn_memory::attack_process(const wchar_t* processName) {
