            ...
            else
            {
                ...
                if (args[0].ToLower().Equals("unpack"))
                {
                    ...
                    foreach (FileInfo file in files)
                    {
                        ...
                        string save_path = ToDir.FullName + "\\" + r_path + "\\" + r_path + ".xml";
                        ...
                        try
                        {
                            ...
                            tr2 = new GECV_EX.Shared.TR2File(File.ReadAllBytes(file.FullName));
                ...
                if (args[0].ToLower().Equals("pack"))
                {
                    ...
                    foreach (FileInfo file in files)
                    {
                        ...
                        TR2Packer packer = new TR2Packer(file.FullName);
